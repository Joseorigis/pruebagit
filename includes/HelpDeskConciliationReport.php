...
// ----------------------------------------------------------------------------------------------------
		...
		if($itemownerid == 18){
			$filterLilly = " OR ItemSKU IN ('7501082243444','7501082243468','7501082243451','7501082242720','7501082242409','7501082243406','7501082243420','7501082224269')";
		}else{
			$filterLilly = "";
		}
            ...
            // TRANSACTIONS DATABASE
                       ...
                       */
                       if($itemownerid == 5){
				        ...
				        if ($items > 0) {
                            ...
                            if($itemownerid == 8 || $itemownerid == 9 || $itemownerid == 16 || $itemownerid == 18){
                                $sheet->setCellValue('H1','UnitsDiscount');
                                $sheet->setCellValue('I1','ItemDiscount');
                            }
                ...
                if($typeReport == 2)//sustentos lilly
                {
                        ...
                        $query = @" SELECT
									...
									AND FAHORRO.transaccionstatus IN ('FailDiscountQuantity','FailDiscountUnknown','OKdiscount')
                                    ORDER BY convert(int,S.ConnectionId);"; //Fahorro end 
				        
				        $dbtransactions->query($query);//echo $query;exit;
