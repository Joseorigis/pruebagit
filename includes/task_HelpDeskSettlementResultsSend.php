	...
	// --------------------------------------------------
			...
			// NOTIFICATIONS LIST		
				...
				while($my_row=$dbtransactions->get_row()){	
										...
										// CONTENT LIST
											...
											// PERIODO
												...
												// OWNER CONNECTIONS LIST												
													...
													$OwnerConnectionsList .= "<td style='font-size:10px;border-right:1px solid #ADB1BD;background-color:#0072C6;color:#FFFFFF;font-weight:bold;padding:5px;'>Tipo</td>";
													$OwnerConnectionsList .= "<td style='font-size:10px;background-color:#0072C6;color:#FFFFFF;font-weight:bold;padding:5px;'>&nbsp</td>";		
													$OwnerConnectionsList .= "</tr>";
										
													$querylist  = "EXEC dbo.usp_app_HelpDeskSettlementManage
																		'0',
																		'".$configuration['appkey']."',
																		'ownerssettlementresults',
																		'".$actionauth."',
													...
													while($my_list=$dbnotificationslist->get_row()){	
														...
														$rowcolor = "FFCC00";
														if ($my_list['SettlementResultsStatus'] == "OK") {
															$rowcolor = "00CC00";
														}
														
														$OwnerConnectionsList .= "<tr style='border-bottom:1px solid #ADB1BD;font-size:9px;background-color:#".$backcolor.";'>";
														$OwnerConnectionsList .= "<td style='font-size:9px;border-right:1px solid #ADB1BD;padding:3px;'>".$my_list['ItemProgram']."<br />";
														$OwnerConnectionsList .= $my_list['CardsPrefix']."</td>";
														...
														$OwnerConnectionsList .= "<td style='font-size:8px;border-right:1px solid #ADB1BD;padding:3px;'>";
														$OwnerConnectionsList .= "".$my_list['SettlementResultsStatus']."<br />".$my_list['SettlementResultsDate'];
														$OwnerConnectionsList .= "</td>";
														$OwnerConnectionsList .= "<td style='font-size:8px;padding:3px;background-color:#".$rowcolor."'>";
														$OwnerConnectionsList .= "&nbsp";
														$OwnerConnectionsList .= "</td>";
														$OwnerConnectionsList .= "</tr>";
													...
													if ($OwnerConnectionsList == "") {
														$OwnerConnectionsList = "<tr><td colspan='4'><i>[Sin Cadenas]</i></td></tr>";
													}
						...
						$EmailTo 		= "raulbg@origis.com,helpdesk@orbisfarma.com.mx";
