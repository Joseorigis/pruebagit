...
// --------------------
	...
	// --------------------------------------------------
			...
			$InteractionMonitor 	= ''; 
			$InteractionListId		= 0; 
			$InteractionListContent	= '../templates/HelpDeskTicketOfflineTemplate.html';  
			...
			$InteractionContent 	= 'templates/HelpDeskTicketOfflineTemplate.html'; 
				...
				while($my_row=$dbtransactions->get_row()){	
						...
						// CONTENT LIST
							...
							if ($items == 0) {
								...
								$WarningContent	= '<br /><span style="font-style:italic;font-size:16px;">Sin Alarmas</span><br />';
