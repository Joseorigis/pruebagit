...
// --------------------
	...
	// --------------------------------------------------
			...
			// CONTENT VARIABLES		
                ...
                $TicketContent['TicketOfflineAdministrator'] = 'David Flores';
                $invoicemonitor = 'TICKET TEST';
                $ticketmonitor = 'davidfr@origis.com';
                $TicketContent['TicketOfflineStatus'] = 'OPEN';
                $TicketContent['RecordId'] = '1001';
				$TicketContent['CaseNumber'] = '0T00012849';
				$TicketContent['CardNumber'] = '6001000000001';
				$TicketContent['ItemOwner'] = 'ORBIS';
                $TicketContent['RecordSource'] = 'MANUALLY';
				$TicketContent['TicketOfflineFileExists'] = 'NO';
				$TicketContent['TicketOfflineFileAllowed'] = 'SI';
				$TicketContent['ConnectionName'] = 'ORBISFARMA';
				$TicketContent['ConnectionId'] = '1';
				$TicketContent['Store'] = '999';
				$TicketContent['ItemQuantity'] = '10';
				$TicketContent['ItemSKU'] = '7503783989383';
				$TicketContent['ItemName'] = 'CALCETOSE';
				$TicketContent['ItemBrand'] = 'CHOTOMILK';
				$TicketContent['InvoiceNumber'] = 'T849843';
				$TicketContent['InvoiceDate'] = '20181030';
				$TicketContent['TicketOfflineNotes'] = 'Carguen mi ticket pls';
				...
				$EmailMessage['To']   	  = 'davidfr@origis.com';//$EmailTo;
				...
				$EmailMessage['Body'] = $InteractionContentText;
					...
					// --------------------------------------------------
                            ...
                            Echo 'Llegue hasta aqui: '.$InteractionResult;
                            //exit();
