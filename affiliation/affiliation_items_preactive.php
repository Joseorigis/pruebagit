...
// --------------------
	...
	// Si falta algún parámetro (isset) enviados... ERROR
		...
		$query = "EXEC ".$_SESSION[$configuration['appkey']]['appprefix']."dbo.usp_app_AffiliationItemStatusManage 'preactive', 
							'".$affiliationid."',
							'0',
      ...
      <tr>
        ...
        <td class="templatemainbody">
	        <br />
					...
					<?php 
                    // Si el usuario fue preactivado con exito....
                    if ($actionerrorid == 0) { 
                    ?>
                         ...
                         <tr>
                          ...
                          <tr>
                            <td>
                                ...
                                La tarjeta ha sido PREACTIVADA!.<br />
                                <br />
...
<br /><br />
                                    La tarjeta NO pudo ser PREACTIVADA!.<br />
                                    <br />
                        ...
                        <table class="botones2">
                          <tr>
                           ...
                           <?php if ($actionerrorid == 0) { ?>
                            ...
                            <a href="?m=affiliation&s=items&a=block&n=<?php echo $affiliationid; ?>">Bloquear</a>
                            </td>
                            <?php } ?>
                          </tr>
                        </table>
