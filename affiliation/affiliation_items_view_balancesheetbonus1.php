...
?>
							...
							<?php
                                ...
                                $query  = "EXEC ".$_SESSION[$configuration['appkey']]['appprefix']."dbo.usp_app_AffiliationItemBalanceBonusPending '".$_GET['n']."', '0';";
                            ...
                            <table class="itemdetail">
                              <thead>
                              <tr>
                                <td colspan="7">Bonificaciones Pendientes</td>
                              </tr>
                              <tr>
							...
							while($my_row=$dbconnection->get_row()){ 
											...
											?>
										  <tr>
											<td class="itemdetaillistelement" style="font-size:9px;">
											...
											<span style="font-size:9px;font-style:italic;"><?php echo $my_row['ItemName']; ?></span>
											</td>
											<td class="itemdetaillistelement">
                                            <span style="font-size:10px;font-style:italic;color:#F00;">
											<?php echo $my_row['Quantity']; ?> caja(s) BONIFICACI&Oacute;N
                                            </span>
											</td>
											<td class="itemdetaillistelement">
                                            &nbsp;
                            ...
                            <?php } ?>
							  ...
							  if ($items == 0) {
								  ?>
                            	<tr>
                                <td class="itemdetaillistelement" align="center" colspan="7">
