...
// --------------------
	...
	// GET RECORD
		...
		$affiliationstatusid= "0";
			...
			$query  = "EXEC ".$_SESSION[$configuration['appkey']]['appprefix']."dbo.usp_app_AffiliationItemStatusManage 'blockredemption', 
								'".$itemid."',
								'0',
							...
							<table border="0" cellspacing="0" cellpadding="10">
                              ...
                              <tr>
                                <td>
                                    ...
                                    La TARJETA ha sido BLOQUEADA para REDENCI&Oacute;N!.<br />
                                    <br />
...
<br /><br />
                                        La TARJETA NO pudo ser BLOQUEADA para REDENCI&Oacute;N!.<br />
                                        <br />
                            ...
                            <table class="botones2">
                              <tr>
                               ...
                               <?php if ($actionerrorid == 0) { ?>
                                ...
                                <a href="?m=affiliation&s=items&a=unblockredemption&n=<?php echo $affiliationid; ?>">Desbloquear REDENCI&Oacute;N</a>
                                </td>
                                <?php } ?>
                              </tr>
                            </table>
