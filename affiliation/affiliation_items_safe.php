				...
				if ($items > 0) {
					...
					$affiliationstatusid= $my_row['CardStatusId'];
						...
						// TRANSACTIONS DATABASE
							...
							$elements = $dbtransactions->count_rows();
							if ($elements > 0) {
								$mytransactionrow = $dbtransactions->get_row();
								$safelistdays = trim($mytransactionrow['ParameterValue']); 
								if ($safelistdays == '0') { $safelistdays = '30'; }
							}
                        ...
                        ?>
                              ...
                              <tr>
                                <td>
                                    ...
                                    La TARJETA ha sido AGREGADA por <span style="font-weight:bold;font-size:14px;"><?php echo $safelistdays; ?> d&iacute;as</span> a SAFELIST!.<br />
                                    <br />
...
<br /><br />
                                        La TARJETA NO pudo ser AGREGADA a SAFELIST!.<br />
                                        <br />
                            ...
                            <table class="botones2">
                              <tr>
                               ...
                               <?php if ($actionerrorid == 0) { ?>
                                ...
                                <a href="?m=affiliation&s=items&a=unsafe&n=<?php echo $affiliationid; ?>">Remover SAFELIST</a>
                                </td>
                                <?php } ?>
                              </tr>
                            </table>
