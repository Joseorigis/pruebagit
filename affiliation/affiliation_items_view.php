            ...
            <td class="templatemainbody">
                                    ...
                                    <table class="tablemessage">
                                      <tr>
                                        ...
                                        <td bgcolor="#F0F0F0">			
                                                ...
                                                <br />
												<br />		
												<?php  if (substr($affiliationcard,0,6) == "667191") { ?>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<img src="images/bulletbarcode.png" />&nbsp;<a href="?m=affiliation&s=cardnumber&a=activate&cid=261&cardnumber=<?php echo $affiliationcard; ?>">Activar Tarjeta [CHEDRAUI]</a><br />     
												<?php  } ?>												
					...
					?>
                        ...
                        <?php } ?>
                      	...
                      	<?php if ($_SESSION[$configuration['appkey']]['userprofileid'] == 1 ||
								$_SESSION[$configuration['appkey']]['userprofileid'] == 2) { ?>
                            <li><a href="affiliation/affiliation_items_view_balanceitems.php?n=<?php echo $affiliationid; ?>&cardnumber=<?php echo $cardnumber; ?>" rel="tabcontainer">
                                Art&iacute;culos2</a></li>        
                        <?php } ?>
                    ...
                    <table class="sidebar">
                        ...
                        <?php } ?>
                            ...
                            <img src="images/bulletbarcode.png" />&nbsp;<a href="?m=affiliation&s=cardnumber&a=send&t=email&n=<?php echo $affiliationid; ?>&cardnumber=<?php echo $cardnumber; ?>">Enviar Tarjeta Virtual</a><br />     
												...
												<?php  if (substr($affiliationcard,0,3) == "260") { ?>
                                                <br />  
												<img src="images/bulletjoin.png" />&nbsp;<a href="?m=reports&s=sanofichedrauimigration&a=list&cardnumber=<?php echo $affiliationcard; ?>" target="_blank">Consultar Transacciones Migracion [CHEDRAUI]</a><br />     
												<?php  } ?>							
                        </td>
                        </tr>
                    </table>
