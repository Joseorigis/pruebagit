...
// --------------------
	...
	// Si falta algún parámetro (isset) enviados... ERROR
		...
		$query = "EXEC ".$_SESSION[$configuration['appkey']]['appprefix']."dbo.usp_app_AffiliationItemStatusManage 'unblock', 
							'".$affiliationid."',
							'0',
                         ...
                         <tr>
                          ...
                          <tr>
                            <td>
                                ...
                                La tarjeta ha sido DESBLOQUEADA!.<br />
                                <br />
...
<br /><br />
                                    La tarjeta NO pudo ser DESBLOQUEADA!.<br />
                                    <br />
