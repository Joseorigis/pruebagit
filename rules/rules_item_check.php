		...
		<!-- RULES : inicio -->
					...
					?>		
							...
							<table class="tableaffiliatedtab">
							  <thead>
							  <tr>
								<td colspan="4" style="border-top: 1px solid #ADB1BD;background-color:#0072C6;color:#ffffff;">
								...
								<td colspan="2" style="font-size:14px;vertical-align: bottom;border-top: 1px solid #ADB1BD;background-color:#0072C6;">&nbsp;
											  ...
											  <tr style="background-color:#<?php echo $bgcolor; ?>">
												...
												<td style="border-right: 1px solid #f0f0f0;">
													...
													* <?php echo $my_row['RewardsLimit']; ?>
													...
													<?php 
														if ($my_row['RuleItemsGroupCount'] > 1) {
															echo "<br />";
															echo "<span style='font-size:8px;font-style:italic;''>";
															echo "<div style='padding-left:30px;''>";
															echo "Buying any of:<br />";
															$itemslist = explode(",",$my_row['RuleItemsGroup']);
															//echo '<pre>';
															//print_r($itemslist);
															//echo '</pre>';	
															foreach($itemslist as $itemone) {
																if (strpos($itemone,$item) !== false) {
																	echo "&nbsp&nbsp&nbsp <strong>> ".$itemone."</strong><br />";
																} else {
																	echo "&nbsp&nbsp&nbsp > ".$itemone."<br />";
																}
															}															
															echo "</div></span>";
														}
												...
												<td style="border-right: 1px solid #f0f0f0;">
													<?php echo $my_row['ListName'].' ['.$my_row['AffiliationListId'].']'; ?>
												</td>
												<td style="border-right: 1px solid #f0f0f0;text-align:center;">
													<?php echo $my_row['RuleKey']; ?><br /><?php echo $my_row['RuleType']; ?>
													<br />
												<?php if ($_SESSION[$configuration['appkey']]['userprofileid'] == 1 ||
													...
													if ($my_row['RulePublishStatus'] == 'ACTIVE') {
													?>
														<a href="?m=rules&s=bonus&a=view&t=bonus&n=<?php echo $my_row['RuleId']; ?>">
														<img src="images/bulletrules.png" alt="Ver Regla" title="Ver Regla" />
														</a>
													<?php
													}
													?>
									...
									while($my_row=$dbtransactions->get_row()){ 
										  ...
										  ?>
											  <tr style="background-color:#<?php echo $bgcolor; ?>">
												...
												<td style="border-right: 1px solid #f0f0f0;">&nbsp;</td>
												<td style="border-right: 1px solid #f0f0f0;">&nbsp;</td>
											  </tr>
								<?php 
									}
									...
									if ($records == 0) {
										...
										echo "<tr><td colspan='6' style='font-style:italic;'>* FARMACIAS INDEPENDIENTES no se muestran.</td></tr>";
									}
