...
//					}
			...
			// ruleparams ... for copy
				...
				$ruleparams .= "&rulename=".$_GET['rulename'];
								...
								?>
                                    ...
                                    <table class="botones2">
                                      <tr>
                                        ...
                                        <a href="?m=rules&s=<?php echo $itemtype; ?>item&a=new&connection=<?php echo $connectionid; ?>&item=<?php echo $ruleitem; ?>" target="_blank" >Agregar Art&iacute;culo</a>
                                        </td>
                                      </tr>
                                    </table>
                                	<br />
					...
					<?php } ?>	
                        ...
                        <table class="botones2">
                          <tr>
                            ...
                            <td class="botonstandard">
                            <img src="images/bulletnew.png" />&nbsp;
                            <a href="?m=rules&s=<?php echo $itemtype; ?>&a=new">Nueva Regla Bonificaci&oacute;n</a>
                            </td>
                            <td class="botonstandard">
                            <img src="images/bulletadd.png" />&nbsp;
                            <a href="?m=rules&s=bonusitem&a=new&t=bonus">Nuevo Art&iacute;culo</a>
                            </td>
                           <!--<td class="botonstandard">
                            <img src="images/bulletnew.png" />&nbsp;
                            <a href="?m=rules&s=warnings&a=new">Nueva Regla Alarma</a>
                            </td>-->
                          </tr>
                        </table>
                    <br /><br />
