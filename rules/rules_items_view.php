                                        ...
                                        <table class="tablelistitems">
                                          ...
                                          <?php 
											...
											while($my_row=$dbtransactions->get_row()){ 
												...
												$colour = "f0f0f0";
												if ($my_row['RuleType'] == 'bonus') { $colour = "0072C6"; }
												if ($my_row['RuleType'] == 'discounts') { $colour = "30C806"; }
                                          ?>
                                              <tr>
                                                <td align="right" style="border-right: 5px solid #<?php echo $colour; ?>;"><?php echo  $itemindex; ?></td>
                                                <td>
                                                	<a href="?m=rules&s=<?php echo $my_row['RuleType']; ?>&a=view&n=<?php echo $my_row['RuleKey']; ?>&t=<?php echo strtoupper($my_row['RuleType']); ?>">
