...
//					}
	...
	// RECORD PROCESS...	
		...
		$operation = "update".$itemquery;

		if ($operation == "update") { $actionerrorid = "2"; }
                                ...
                                <br />
                                    ...
                                    <table class="botones2">
                                      <tr>
                                        ...
                                        <a href="?m=rules&s=<?php echo $itemtype; ?>&a=edit&t=<?php echo $itemtype; ?>&q=item&n=<?php echo $itemid; ?>" target="_blank" >Agregar Art&iacute;culo a Regla</a>
                                        </td>
                                      </tr>
                                    </table>
                                	<br />
