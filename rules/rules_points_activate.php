								...
								switch ($actionerrorid) {
									case 14:
										?>    
                                            ...
                                            La regla NO pudo ser ACTIVADA!.<br />
                                            <br />
                                            La regla ya ha sido activada anteriormente.&nbsp;
                        ...
                        <table class="botones2">
                          <tr>
                           ...
                           <?php if ($actionerrorid == 0) { ?>
                            ...
                            <a href="?m=rules&s=points&a=deactivate&n=<?php echo $itemid; ?>">Desactivar Regla</a>
                            </td>
                            <?php } ?>
                            <td class="botonstandard">
