...
// --------------------
	...
	// REFERER
		...
		$query  = "EXEC ".$_SESSION[$configuration['appkey']]['appprefix']."dbo.usp_tsk_RulesEngine;";
                ...
                <table border="0" cellspacing="0" cellpadding="10">
                    ...
                    ?>
                          ...
                          <tr>
                            <td>
                            Reglas<br />
                            <span class="textMedium"><em>TODAS las Reglas de Puntos</em></span><br />
                            <br />
                            </td>
                          </tr>
                          <tr>
                            <td>
                                ...
                                La reglas han sido PUBLICADAS!.<br />
                                <br />
								...
								switch ($actionerrorid) {
									case 14:
										?>    
                                            ...
                                            Las reglas NO pudieron ser PUBLICADAS!.<br />
                                            <br />
                                            Las reglas ya han sido activadas anteriormente.&nbsp;
									...
									case 102:
										?>    
                                            ...
                                            Las reglas NO pudieron ser PUBLICADAS!.<br />
                                            <br />
                                            Las reglas o su configuraci&oacute;n ya han sido cargadas anteriormente.&nbsp;
                                            <em>[Err <?php echo $actionerrorid; ?>]</em><br />
										<?php  
										break;
									default:
