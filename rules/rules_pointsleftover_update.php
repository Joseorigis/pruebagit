                ...
                <table border="0" cellspacing="0" cellpadding="10">
                    ...
                    ?>
                          ...
                          <tr>
                            <td>
                            Regla<br />
                            <span class="textMedium"><em>Sobrantes</em></span><br />
                            <br />
                            La regla de Equivalencia Sobrantes de acumulaci&oacute;n de <strong><?php echo $PointsDefault; ?>%</strong> ha sido actualizada.<br />
							<br />
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td valign="bottom">
                                    ...
                                    <table border="0">
                                      <tr>
                                        ...
                                        <td width="24">&nbsp;</td>
                                        <td valign="bottom">
                                        <span class="textMedium">Regla<br />Actualizar Regla Sobrantes</span><br />
                                        </td>
                                      </tr>
                                    </table>
