    ...
    <table class="template">
      <tr>
        ...
        <br />
                    ...
                    <br />
                    <ul id="interactionstabs" class="shadetabs2">
                    <li><a href="#" class="selected" rel="#default">Interacciones</a></li>
                    </ul>
                    <div id="interactionsdivcontainer" class="shadetabs2divcontainer">
			...
			<!-- LIST GRID:begin -->            
                <table class="tablelist">
                  <thead>
                  <tr>
                    <td width="50%">Interacci&oacute;n</td>
                    <td width="10%">Medios</td>
                    <td width="20%">Status</td>
                    <td width="20%">Medici&oacute;n</td>
                  </tr>
                  </thead>
                  <tbody>
                          <tr>
                            <td colspan="4" align="center"><span style="font-style:italic;">Sin Interacciones</span></td>
                          </tr>
                  </tbody>
                </table>
                            </div>
                    ...
                    var tabs=new ddajaxtabs("interactionstabs", "interactionsdivcontainer")
