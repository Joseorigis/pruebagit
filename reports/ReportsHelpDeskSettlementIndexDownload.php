...
// IF SESSION...
	if (isset($_SESSION[$configuration['appkey']])) {
		...
		fputcsv($output, array('SettlementDate',
								'ItemOwnerId','ItemOwnerName',
							    'ItemProgram',
								'ConnectionId','ConnectionName',
								'ConnectionType','ConnectionApp',
								'ConnectionOwners','SettlementType',
								'SettlementStatus',
								'StatusKeyword','StatusDesc',
								'StatusContactDate','StatusContactName'));
		...
		while($my_row=$dbtransactions->get_row()) {
			 ...
			 $row .= $my_row["ItemProgram"].",";
			 $row .= $my_row["ConnectionId"].",".$my_row["ConnectionName"].",";
			 $row .= $my_row["ConnectionType"].",".$my_row["ConnectionApp"].",";
			 $row .= $my_row["ConnectionOwners"].",".$my_row["SettlementType"].",";
			 $row .= ",,,,";			
