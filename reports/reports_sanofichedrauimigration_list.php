            ...
            <td class="templatemainbody">
                ...
                <br />    
                    <?php
						...
						$items = 0;
						$itemindex = 0;
						$query = "EXEC ".$_SESSION[$configuration['appkey']]['appprefix']."dbo.usp_app_ReportsSanofiChedrauiMigration
											'0', '".$cardnumber."',
											'".$_SESSION[$configuration['appkey']]['userid']."', 
											'".$configuration['appkey']."';";//echo $query;
