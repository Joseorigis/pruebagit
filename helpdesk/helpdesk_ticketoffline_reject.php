                    ...
                    <br />
                        ...
                        ?>
                              <tr>
                                <td>
                                    ...
                                    El TICKET OFFLINE ha sido RECHAZADO!.<br />
                                    <br />
                                    <br />
                                    ...
                                    El rechazo del ticket ha sido enviado al usuario que lo agreg&oacute;.
                                    </span>
                        ...
                        <?php } else { ?>	
                          ...
                          <tr>
                            <td>
                                ...
                                <br /><br />
                                El TICKET OFFLINE NO pudo ser RECHAZADO!.<br />
                                <br />
                                <br />
                        ...
                        <table class="botones2">
                          <tr>
                            ...
                            <a href="?m=helpdesk&s=ticket&a=view&cardnumber=<?php echo $cardnumber; ?>&n=<?php echo $itemid; ?>">Ver Ticket</a>
                            </td>
                          </tr>
                        </table>
                    	<br /><br />
