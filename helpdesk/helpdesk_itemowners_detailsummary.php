...
?>
                            ...
                            <table class="itemdetail">
                              ...
                              <tr>
                                ...
                                <td class="itemdetailcontent"><?php echo $my_row['ItemOwnerId']; ?></td>
                              </tr>
                              <tr>
                                <td class="itemdetailconcept">T&iacute;tulo:</td>
                                <td class="itemdetailcontent"><?php echo $my_row['ItemOwnerName']; ?></td>
                              </tr>
                              <tr>
                                <td class="itemdetailconcept">Descripci&oacute;n:</td>
                                <td class="itemdetailcontent"><?php echo $my_row['ItemOwner']; ?></td>
                              </tr>
                              <tr>
                                <td class="itemdetailconcept">Programa:</td>
                                <td class="itemdetailcontent"><?php echo $my_row['ItemOwnerProgram']; ?></td>
                              </tr>
                              <tr>
                                <td class="itemdetailconcept">Keyword:</td>
                                <td class="itemdetailcontent"><?php echo $my_row['ItemOwnerProgramKeyword']; ?></td>
                              </tr>
                              <tr>
                                <td class="itemdetailconcept">Tipo:</td>
                                <td class="itemdetailcontent"><?php echo $my_row['ItemOwnerType']; ?></td>
                              </tr>
                              </tbody>
                            </table>
							<br /><br />
