...
//		}
	...
	// PARAMETER VALIDATION
		...
		// connectionid ... in case off
			$connectionid = 0;
			if (isset($_GET['itemownerid'])) {
				$connectionid = setOnlyNumbers($_GET['itemownerid']);
		...
		// CONNECTION SEARCH
			$connectionname			= '';
					...
					if ($items > 0) {
						...
						$connectionname		= $my_row['ItemOwnerName'];
						$ContactName		= $my_row['ContactName'];
						$ContactEmail		= $my_row['ContactEmail'];
						$ContactCellPhone	= $my_row['ContactCellPhone'];
						$ContactPhone	    = $my_row['ContactPhone'];
						$ContactNotes	    = $my_row['ContactNotes'];
					} else {
						$actionerrorid = 2;
					}
    ...
    <table class="template">
      <tr>
        ...
        <td class="templatemainbody">
                ...
                <input name="s" type="hidden" value="itemownerscontact" />
                ...
                <input name="itemownerid" type="hidden" value="<?php echo $connectionid; ?>" />
                ...
                <table border="0" cellspacing="0" cellpadding="10">
                  ...
                  <tr>
                    <td>
                     Nombre<br/>
                    <input name="addressname" id="addressname" type="text" size="50" class="inputtextrequired" value="<?php echo $ContactName; ?>" /><br />
                    <span class="textHint">
                  ...
                  <tr>
                    <td>
                     Email<br/>
                    <input name="addressemail" id="addressemail" type="text" size="50" class="inputtextrequired" value="<?php echo $ContactEmail; ?>" /><br />
                    <span class="textHint">
                  ...
                  <tr>
                    <td>
                     Tel&eacute;fono<br/>
                    <input name="addressphone" id="addressphone" type="text" class="inputtextrequired" value="<?php echo $ContactPhone; ?>" /><br />
                    <span class="textHint">
                  ...
                  <tr>
                    <td>
                     Celular<br/>
                    <input name="addresscellphone" id="addresscellphone" type="text" class="inputtextrequired" value="<?php echo $ContactCellPhone; ?>" /><br />
                    <span class="textHint">
                  ...
                  <tr>
					...
					<input name="addresssubtype" id="addresssubtype" type="radio" value="contacto" />&nbsp;Otro<br />
                       ...
                       <tr>
                        <td>
                        Notas<br />
                        <textarea name="addressnotes" id="addressnotes" cols="80" rows="3" title="Notas del Contacto" maxlength="250" style="font-size:10px;"><?php echo $ContactNotes; ?></textarea><br />
