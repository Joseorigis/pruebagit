                    ...
                    ?>
                          <tr>
                            <td>
                                ...
                                La BONIFICACI&Oacute;N ha sido RECHAZADA!.<br />
                                <br />
                                <br />
					...
					<?php } else { ?>	
                          ...
                          <tr>
                            <td>
                                ...
                                <br /><br />
                                La BONIFICACI&Oacute;N NO pudo ser RECHAZADA!.<br />
                                <br />
                                <?php
									// Error message...
					...
					<?php } ?>	
                        ...
                        <table class="botones2">
                          <tr>
                            ...
                            <td class="botonstandard">
                            <img src="images/bulletticket.png" />&nbsp;
                            <a href="?m=reports&s=transactions&a=view&n=<?php echo $itemid; ?>&cardnumber=<?php echo $cardnumber; ?>&t=sale&q=<?php echo $transactionid; ?>">Ver Transacci&oacute;n</a>
                            </td>
                          </tr>
                        </table>
                    <br /><br />
