                    ...
                    ?>
                          <tr>
                            <td>
                                ...
                                El HISTORIAL ha sido AJUSTADO!.<br />
                                <br />
                                <br />
                                Actualizaci&oacute;n N&uacute;mero: 
					...
					<?php } else { ?>	
                          ...
                          <tr>
                            <td>
                                ...
                                <br /><br />
                                El HISTORIAL NO pudo ser AJUSTADO!.<br />
                                <br />
                                <?php
									// Error message...
					...
					<?php } ?>	
                        ...
                        <table class="botones2">
                          <tr>
                            ...
                            <a href="?m=helpdesk&s=bonusfree&a=new&t=bonusfree&n=<?php echo $itemid; ?>&cardnumber=<?php echo $cardnumber; ?>">Aplicar Bonificaci&oacute;n</a>
                            </td>
                          </tr>
                        </table>
                    <br /><br />
