    ...
    <table class="template">
      <tr>
        ...
        <td class="templatemainbody">
                ...
                <input name="a" type="hidden" value="updateflags" />
                ...
                <table border="0" cellspacing="0" cellpadding="10">
                  ...
                  <tr>
                    ...
                    Flags<br />
                    <span class="textMedium"> 
                    <?php echo $my_row['ConnectionFlags']; ?>
                    </span><br />
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                     Flag Nuevo<br/>
                    <input name="connectionflag" id="connectionflag" type="text" class="inputtext" value="" /><br />
                    <span class="textHint">
                    &middot; C&oacute;digo o flag a agregar a la conexi&oacute;n.<br />
                    <span style="#ff0000;">
                    &middot; Solo UN flag a la vez.<br />
                    &middot; NO APLICA Marzam.<br />   
                    </span>                                     
                    </span>
                    </td>
                  </tr>
