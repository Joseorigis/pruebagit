...
?>
                            ...
                            <table class="itemdetail">
                              <thead>
                              <tr>
                                <td colspan="6">Tarjetas</td>
                              </tr>
                              <tr>

                                <td class="itemdetailheader">Prefijo</td>
                                <td class="itemdetailheader">Tipo</td>
                                <td class="itemdetailheader">Serie</td>
                                <td class="itemdetailheader">Cadena</td>
                                <td class="itemdetailheader">Rango</td>                                
							...
							while($my_row=$dbtransactions->get_row()){ 
										  ...
										  <tr>
                                            ...
                                            <?php echo $my_row['CardsPrefix']; ?>
                                            </span>
											</td>
											<td class="itemdetaillistelement">
                                            <?php echo $my_row['CardType']; ?>
											</td>
											<td class="itemdetaillistelement">
											<?php echo $my_row['CardSeries']; ?>
											</td>
											<td class="itemdetaillistelement">
											...
											<td class="itemdetaillistelement">
                                            <span style="font-size:9px;">
											<?php echo $my_row['CardsSeriesStart']; ?> - <?php echo $my_row['CardsSeriesEnd']; ?>
                                            </span>
											</td>
											<td class="itemdetaillistelement">
                                            <span style="font-size:8px;">
											<?php echo $my_row['CardsSeriesDate']; ?>
                                            </span>
											</td>
										  </tr>
										 <?php
							  ...
							  if ($items == 0) {
                                ...
                                <div align="center"><em>Sin Tarjetas</em></div>
								</td>
                                </tr>
                                  <?php
							  } 
