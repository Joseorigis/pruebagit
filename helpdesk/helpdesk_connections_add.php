	...
	// PARAMETER VALIDATION
		...
		// connection data
			...
			if (isset($_GET['connectionname'])) {
				...
				if ($connectionname == "") { 
					$actionerrorid = 2;
					$errormessage .= "&middot;&nbsp;El nombre de la conexión ingresado no es v&aacute;lido!<br />";
				} 
			} else {
				$actionerrorid = 1;
			}
			...
			if (isset($_GET['connectiontype'])) {
				...
				if ($connectiontype == "") { 
					$actionerrorid = 2;
					$errormessage .= "&middot;&nbsp;El tipo de conexión ingresado no es v&aacute;lido!<br />";
				} 
			} else {
				$actionerrorid = 1;
			}
			...
			if (isset($_GET['connectionapp'])) {
				...
				if ($connectionapp == "") { 
					$actionerrorid = 2;
					$errormessage .= "&middot;&nbsp;La aplicación de la conexión ingresada no es v&aacute;lida!<br />";
				} 
			} else {
				$actionerrorid = 1;
			}
			...
			if (isset($_GET['connectionwebservice'])) {
				...
				if ($connectionwebservice == "") { 
					$actionerrorid = 2;
					$errormessage .= "&middot;&nbsp;El servicio web de la conexión ingresada no es v&aacute;lida!<br />";
				} 
			} else {
				$actionerrorid = 1;
			}
