...
?>
							...
							while($my_row=$dbtransactions->get_row()){ 
										  ...
										  <tr>
                                            ...
                                            <a href="?m=helpdesk&s=connectionscontact&a=edit&connectionid=<?php echo $itemid; ?>&n=<?php echo $my_row['RecordId']; ?>" title="Ver Contacto">
											...
											<td class="itemdetaillistelement" align="right">
                                            <a href="?m=helpdesk&s=connectionscontact&a=delete&connectionid=<?php echo $itemid; ?>&n=<?php echo $my_row['RecordId']; ?>" title="Eliminar Contacto">
                            ...
                            <table class="botones2" align="center">
                              <tr>
                                ...
                                <a href="?m=helpdesk&s=connectionscontact&a=new&connectionid=<?php echo $itemid; ?>">Agregar Contacto</a>
                                </td>
                              </tr>
                            </table> 
                            <br />
