	...
	// RECORD PROCESS...	
		...
		if ($actionerrorid == 0) {
					...
					if ($records > 0) {
						...
						if ($actionerrorid == 0){
							$connectionid	= $my_row['ItemOwnerId']; 
							$connectionname	= $my_row['ItemOwnerName']; 
							$addressname	= $my_row['ContactName']; 
						}
                    ...
                    ?>
                          <tr>
                            <td>
                                ...
                                El CONTACTO ha sido ELIMINADO!.<br />
                                <br />
                                <br />
					...
					<?php } else { ?>	
                          ...
                          <tr>
                            <td>
                                ...
                                <br /><br />
                                El CONTACTO NO pudo ser ELIMINADO!.<br />
                                <br />
                                <?php
									// Error message...
					...
					<?php } ?>	
                        ...
                        <table class="botones2">
                          <tr>
                            ...
                            <a href="?m=helpdesk&s=itemowners&a=view&n=<?php echo $connectionid; ?>&t=itemowners">Ver Owner</a>
                            </td>
                            <td class="botonstandard">
                            <img src="images/bulletadd.png" />&nbsp;
                            <a href="?m=helpdesk&s=itemownerscontact&a=new&itemownerid=<?php echo $connectionid; ?>&t=<?php echo $itemtype; ?>">Agregar Contacto Este Owner</a>
                            </td>
                          </tr>
                        </table>
                    <br /><br />
