...
// --------------------
	...
	// MODULE script assembly
		...
		// ItemType BONUS / POINTS / WARNINGS
			if (isset($itemtype)) {
				if (trim($itemtype) == '') { $itemtype = 'CONNECTIONS'; }
			} else {
...
//-->
			...
			<!-- LIST GRID:begin -->   
                ...
                <table class="tablelist">
                  <thead>
                  <tr>
                    <td width="30%">Conexi&oacute;n</td>
                    <td width="20%">Tipo</td>
                    <td width="20%">Integraci&oacute;n</td>
			...
			// PAGING CONTENT OR LIST
				...
				while($my_row=$dbtransactions->get_row()){ 
                  ...
                  ?>
                      <tr>
                        <td>
                        <a href="?m=helpdesk&s=<?php echo strtolower($itemtype); ?>&a=view&n=<?php echo $my_row['ConnectionId']; ?>&t=<?php echo strtolower($itemtype); ?>">
						...
						<?php echo $my_row['ConnectionService']; ?>
                        </span>
                        </td>
                        <td>
						<?php echo $my_row['ConnectionStatus']; ?><br />
                        <span style="font-size:9px;">
						* A <?php echo $my_row['ConnectionDateStatus']; ?>
                        </span>
                        </td>
                        <td><?php echo $my_row['ConnectionActivationDate']; ?></td>
                      </tr>
                 <?php
                  }
				  if ($pagingelements == 0) {
					  ?>
                          <tr>
                            <td colspan="5" align="center"><span style="font-style:italic;">Sin Conexiones</span></td>
                          </tr>
