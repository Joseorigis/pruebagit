...
?>
                            ...
                            <table class="itemdetail">
                              <thead>
                              <tr>
                                <td colspan="6">Conexiones</td>
                              </tr>
                              <tr>
                                <td class="itemdetailheader">ID</td>
                                <td class="itemdetailheader">Conexi&oacute;n</td>
                                <td class="itemdetailheader">APP</td>
                                <td class="itemdetailheader">Tipo</td>
                                <td class="itemdetailheader">Conciliaci&oacute;n</td>
							...
							while($my_row=$dbtransactions->get_row()){ 
										  ...
										  <tr>
                                            ...
                                            <a href="?m=helpdesk&s=connections&a=view&n=<?php echo $my_row['ConnectionId']; ?>&t=connections" title="Ver Conexion" target="_blank">
											...
											<td class="itemdetaillistelement">
                                            <span style="font-size:9px;">
											<?php echo $my_row['SettlementType']; ?>
                                            </span>
											</td>
											<td class="itemdetaillistelement">
                                            <span style="font-size:8px;">
											<?php echo $my_row['ConnectionDate']; ?>
                                            </span>
											</td>
										  </tr>
										 <?php
                            ...
                            <table class="botones2" align="center">
                              <tr>
                                ...
                                <a href="?m=helpdesk&s=itemownersconnections&a=new&itemownerid=<?php echo $itemid; ?>">Agregar Conexi&oacute;n</a>
                                </td>
                              </tr>
                            </table> 
                            <br />
