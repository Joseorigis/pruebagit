	...
	// PARAMETER VALIDATION
		...
		// CONNECTION SEARCH
			...
			$connectionname			= '';
					...
					// SET RECORDS...
					$items = 0;
					$query  = "EXEC ".$_SESSION[$configuration['appkey']]['appprefix']."dbo.usp_tsk_HelpDeskMarzamConnectionItems;";
                  ...
                  <tr>
                    <td valign="bottom">
                            ...
                            <table border="0">
                              <tr>
                                ...
                                Help Desk<br />
                                Activar Art&iacute;culos Marzam
                                </span><br />
                                </td>
                              </tr>
                            </table>
                        ...
                        ?>
                              <tr>
                                <td>
                                    ...
                                    Los ARTICULOS han sido ACTIVADOS!.<br />
                                    <br />
                                    <br />
                                </td>
                              </tr>                          
                        ...
                        <?php } else { ?>	
                          ...
                          <tr>
                            <td>
                                ...
                                <br /><br />
                                Los ARTICULOS NO pudieron ser ACTIVADOS!.<br />
                                <br />
                                <br />
                                <?php
									// Error message...
                    ...
                    <table class="botones2">
                      <tr>
                        ...
                        <img src="images/bullethelpdesk.png" />&nbsp;
                        <a href="?m=helpdesk">Help Desk</a>
                        </td>
                      </tr>
                    </table>
                    	<br /><br />
