...
// --------------------
	...
	// PARAMETER VALIDATION
		...
		// address data
			...
			// latitude & longitude
			$addresslatitude = "0";
			if (isset($_GET['addresslatitude'])) { 
				$addresslatitude = setOnlyText($_GET['addresslatitude']);
				if ($addresslatitude == "")
					{ $addresslatitude = "0"; }
			}
			$addresslongitude = "0";
			if (isset($_GET['addresslongitude'])) { 
				$addresslongitude = setOnlyText($_GET['addresslongitude']);
				if ($addresslongitude == "")
					{ $addresslongitude = "0"; }
			}			
			...
			$addressstate = "";
			if (isset($_GET['state'])) { 
				$addressstate = setOnlyText($_GET['state']);
//				if ($addressstate == "")
//					{ $actionerrorid = 2; }
				 }
			else 
			...
			if (isset($_GET['county'])) { 
				$addresscounty = setOnlyText($_GET['county']);
//				if ($addresscounty == "")
//					{ $actionerrorid = 2; }
				 }
			else 
			...
			$addresscity = "";
			if (isset($_GET['city'])) { 
				$addresscity = setOnlyText($_GET['city']);
//				if ($addresscity == "")
//					{ $actionerrorid = 2; }
				 }
			else 
			...
			if (isset($_GET['colony'])) { 
				$addresscolony = setOnlyText($_GET['colony']);
//				if ($addresscolony == "")
//					{ $actionerrorid = 2; }
				 }
			else 
			...
			if (isset($_GET['address'])) { 
				$addressstreet = setOnlyText($_GET['address']);
				//if ($addressstreet == "")
				//	{ $actionerrorid = 2; }
				 }
			else 
			...
			if (isset($_GET['zipcode'])) { 
				$addresszipcode = setOnlyNumbers($_GET['zipcode']);
//				if ($addresszipcode == "")
//					{ $actionerrorid = 2; }
				 }
			else 
			...
			if (isset($_GET['storecode'])) {
				$storecode = setOnlyText($_GET['storecode']);
			//} else {
			//	$actionerrorid = 1;
			}
	        ...
	        <br />
                ...
                <table border="0" cellspacing="0" cellpadding="10">
                  ...
                  <tr>
                    ...
                    <br />
                    Sucursal<br />
                    <span class="textMedium"><em><?php echo $addressname; ?> [<?php echo $itemid; ?>]</em></span><br />
                    <br />
                    </td>
                  </tr>
                    ...
                    ?>
                          <tr>
                            <td>
                                ...
                                La SUCURSAL ha sido ACTUALIZADA!.<br />
                                <br />
                                <br />
					...
					<?php } else { ?>	
                          ...
                          <tr>
                            <td>
                                ...
                                <br /><br />
                                La SUCURSAL NO pudo ser ACTUALIZADA!.<br />
                                <br />
                                <?php
									// Error message...
