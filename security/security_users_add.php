		...
		if ($actionerrorid == 0) {
				...
				// Agregamos el USER a la aplicación...
					...
					if ($actionerrorid == 0) {
						...
						// EMAIL CONTENT					
							$EmailMessage['Subject'] = "Tu Nuevo Acceso";				
							$EmailMessage['Content'] = "templates/UserNew.html";
							...
							// Si es LDAP no mandamos password
							if ($userldap == 1) {
								$EmailMessage['Body'] = str_replace("|PASSWORD|", "<em>[Active Directory Password]</em>", $EmailMessage['Body']);
							} else {
                    ...
                    ?>
                          ...
                          <tr>
                            <td>
                                ...
                                El usuario <strong><?php echo $my_row['Username']; ?></strong> fue AGREGADO!.<br />
                                <br />
                          ...
                          <tr>
                            <td>
                            	...
                            	<?php if ($actionerrorid == 110) { ?>
                                    ...
                                    El usuario <strong><?php echo $my_row['Username']; ?></strong> NO pudo ser AGREGADO!.<br />
                                    <br />
